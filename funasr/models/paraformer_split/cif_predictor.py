...
@tables.register("predictor_classes", "CifPredictor_split")
class CifPredictor_split(torch.nn.Module):
    def __init__(
        self,
        idim,
        l_order,
...
@tables.register("predictor_classes", "CifPredictorV2_split")
class CifPredictorV2_split(torch.nn.Module):
    def __init__(
        self,
        idim,
        l_order,
...
@tables.register("predictor_classes", "CifPredictorV2_splitExport")
class CifPredictorV2_splitExport(torch.nn.Module):
